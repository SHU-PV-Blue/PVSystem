...
<div class="modal" id="mymodel1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <!--模态框-->
    <!--模态框-->
    <div class="modal" id="myselfmodel1" tabindex="-1" role="dialog" aria-labelledby="myselfModalLabel1"
         aria-hidden="true">
    ...
    <!--第二个模态框-->
    <div class="modal" id="myselfmodel2" tabindex="-1" role="dialog" aria-labelledby="myselfModalLabe2"
         aria-hidden="true">
        <!--模态框-->
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
    ...
    <!--第三个模态框-->
    <div class="modal" id="myselfmodel3" tabindex="-1" role="dialog" aria-labelledby="myselfModalLabe3"
         aria-hidden="true">
        <!--模态框-->
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
    ...
    <!--第四个模态框-->
    <div class="modal" id="mysefmodel4" tabindex="-1" role="dialog" aria-labelledby="myselfModalLabe4"
         aria-hidden="true">
        <!--模态框-->
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
    ...
    <!--第五个-->
    <div class="modal" id="myselfmodel5" tabindex="-1" role="dialog" aria-labelledby="myselfModalLabe5"
         aria-hidden="true">
        <!--模态框-->
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
    ...
    <!--第6个-->
    <div class="modal" id="myselfmodel6" tabindex="-1" role="dialog" aria-labelledby="myselfModalLabel"
         aria-hidden="true">
        <!--模态框-->
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
    ...
    <!--第七个-->
    <div class="modal" id="myselfmodel7" tabindex="-1" role="dialog" aria-labelledby="myselfModalLabe7"
         aria-hidden="true">
        <!--模态框-->
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
    ...
    <!--第8个-->
    <div class="modal" id="myselfmodel8" tabindex="-1" role="dialog" aria-labelledby="myselfModalLabe8"
         aria-hidden="true">
        <!--模态框-->
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4"><span class="glyphicon glyphicon-remove-" style="color:red"></span>
                            </div>
                        </div>
                    </form>
                </div>
